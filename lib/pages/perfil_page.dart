      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Logado desde: ${formataData(auth.logouEm ?? DateTime.now())}",
            ),
            SizedBox(
